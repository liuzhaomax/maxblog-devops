...
cd main
/home/opc/docker/jenkins_docker/data/sonar-scanner/bin/sonar-scanner -Dsonar.sources=./server -Dsonar.projectname=maxblog-fe-main-main -Dsonar.login=2ec8956b73dda5a079832c03e791c08504afcca0 -Dsonar.projectKey=maxblog-fe-main-main
```
...
```shell
/var/jenkins_home/sonar-scanner/bin/sonar-scanner -Dsonar.sources=./server -Dsonar.projectname=${JOB_NAME} -Dsonar.login=2ec8956b73dda5a079832c03e791c08504afcca0 -Dsonar.projectKey=${JOB_NAME}
```
